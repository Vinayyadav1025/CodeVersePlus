...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      Stay updated with our latest articles, product releases, and industry insights. Join our community to receive exclusive content delivered straight to your inbox.
      </p>
      <div>
        <input
          type="text"
